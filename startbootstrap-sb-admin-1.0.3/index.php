...
#head {
	...
	text-indent: -500em;
	height: 125px;
	background: url(file:///C|/wamp/www/index.php?img=gifLogo) 0 0 no-repeat;
}
.utility {
	position: absolute;
	right: 4em;
...
ul.aliases a, ul.projects a, ul.tools a {
	padding-left: 22px;
	background: url(file:///C|/wamp/www/index.php?img=pngFolder) 0 100% no-repeat;
}
ul.tools a {
	background: url(file:///C|/wamp/www/index.php?img=pngWrench) 0 100% no-repeat;
}
ul.aliases a {
	background: url(file:///C|/wamp/www/index.php?img=pngFolderGo) 0 100% no-repeat;
}
...
dd ul li {
	...
	margin: 0;
	padding: 0 0 0 20px;
	background: url(file:///C|/wamp/www/index.php?img=pngPlugin) 2px 50% no-repeat;
	line-height: 1.6;
}
a {
	color: #024378;
...
.right {float:right;}
	...
	<link rel="shortcut icon" href="file:///C|/wamp/www/index.php?img=favicon" type="image/ico" />
</head>
...
<body>
	...
	<ul class="utility">
		...
		<li><a href="file:///C|/wamp/www/?lang={$langues[$langue]['autreLangueLien']}">{$langues[$langue]['autreLangue']}</a></li>
	</ul>
	...
	<ul class="tools">
		<li><a href="file:///C|/wamp/www/?phpinfo=1">phpinfo()</a></li>
		<li><a href="file:///C|/wamp/www/phpmyadmin">phpmyadmin</a></li>
	</ul>
	</div>
	<div class="third left">
